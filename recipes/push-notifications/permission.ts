/**
 * Push permission handling with denial UX.
 * iOS only prompts once — handle denial gracefully.
 */
...
/** User-facing copy when permission denied */
export const PUSH_DENIED_MESSAGE =
  'Notifications are off. Enable them in Settings → [Your App] → Notifications to receive alerts.';